            ...
            <div class="col-4 pb-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <span class="badge dg-primary">{{$article->state->likes}} <i class="far fa-thumbs-up"></i></span>
                            <span class="badge dg-primary">{{$article->state->views}} <i class="far fa-eye"></i></span>
                        </div>
                        <div class="at-4">
                            Теги:
