    ...
    <div id="app">
        <div class="row mt-5">
            <div class="col-12 p-3">
                ...
                <div class="mt-3">
                    <span class="badge bg-danger">{{$article->state->likes}} <i class="far fa-thumbs-up"></i></span>
        ...
        <div class="row">
            <form action="">
                <div class="mb-3">
                    <label for="commentSubject" class="form-label">Тема комментариев</label>
                ...
                @foreach($article->comments as $comment)
                    <div class="toast showing" style="width: 100%;">
                        <div class="toast-header">
                            <img src="https://via.placeholder.com/50/5F113F/FFFFFF/?text=User" alt="">
